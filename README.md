About r-fit.models-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-fit.models-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1137&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-fit.models-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-fit.models` can be installed with `conda`:
...
```
mamba install r-fit.models
```

It is possible to list all of the versions of `r-fit.models` available on your platform with `conda`:
...
```
mamba search r-fit.models --channel conda-forge
```
...
mamba repoquery search r-fit.models --channel conda-forge

# List packages depending on `r-fit.models`:
mamba repoquery whoneeds r-fit.models --channel conda-forge

# List dependencies of `r-fit.models`:
mamba repoquery depends r-fit.models --channel conda-forge
```
